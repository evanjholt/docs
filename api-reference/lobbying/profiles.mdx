...
url = "https://api.northaxiumdata.ca/v1/lobbying/profiles/LOB-4592"
...
fetch('https://api.northaxiumdata.ca/v1/lobbying/profiles/LOB-4592', {
  headers: {
