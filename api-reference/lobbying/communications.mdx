...
api: "GET /lobbying/communications"
...
url = "https://api.northaxiumdata.ca/v1/lobbying/communications"
...
const url = new URL('https://api.northaxiumdata.ca/v1/lobbying/communications');
