---
title: "Committees"
api: "GET /api/v1/parliamentary/committees"
...
```bash cURL
curl "https://api.northaxiumdata.ca/api/v1/parliamentary/committees?limit=10&session=44-1" \
...
url = "https://api.northaxiumdata.ca/api/v1/parliamentary/committees"
...
const url = new URL('https://api.northaxiumdata.ca/api/v1/parliamentary/committees');
