...
api: "GET /api/v1/contributions/list"
...
```bash cURL
curl "https://api.northaxiumdata.ca/api/v1/contributions/list?limit=10&party=Liberal" \
...
url = "https://api.northaxiumdata.ca/api/v1/contributions/list"
...
const url = new URL('https://api.northaxiumdata.ca/api/v1/contributions/list');
