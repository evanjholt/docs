...
api: "GET /contributions/profiles/{id}"
...
url = "https://api.northaxiumdata.ca/v1/contributions/profiles/CTR-48912"
...
fetch('https://api.northaxiumdata.ca/v1/contributions/profiles/CTR-48912', {
  headers: {
