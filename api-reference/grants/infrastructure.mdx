...
api: "GET /api/v1/grants/infrastructure"
...
```bash cURL
curl "https://api.northaxiumdata.ca/api/v1/grants/infrastructure?limit=10&region=Ontario" \
...
url = "https://api.northaxiumdata.ca/api/v1/grants/infrastructure"
...
const url = new URL('https://api.northaxiumdata.ca/api/v1/grants/infrastructure');
