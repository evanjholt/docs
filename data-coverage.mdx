...
<AccordionGroup>
  ...
  <Accordion title="Lobbying lobbyist name coverage">Trck through the matching registration row, raising effective coverage to ~90%. The MCP tool reflects the same fallback.
  </Accordion>
  ...
  <Accordion title="Parliamentary data lag">
    Parliamentary data reflects the OpenParliament snapshot at ingestion time and may lag the live House of Commons by days to weeks during active sessions.
  </Accordion>
