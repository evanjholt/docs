...
<AccordionGroup>
  ...
  <Accordion title="Can I use NorthAxium Data with Claude?">
    Yes — the MCP server lets Claude Desktop query the API directly in natural language. See the [MCP Server](/model-context-protocol) page for setup instructions. MCP access requires a Developer or Pro plan.
  </Accordion>
