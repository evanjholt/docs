...
The MCP (Model Context Protocol) server exposes 19 tools across 7 domains. Once connected, your AI assistant handles the reasoning while NorthAxium Data supplies the ground truth from primary government sources.
...
Once connected, your AI assistant has access to 19 tools across 7 domains.
